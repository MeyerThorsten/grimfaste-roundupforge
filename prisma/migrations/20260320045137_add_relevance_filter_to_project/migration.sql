...
INSERT INTO "new_Project" ("completedKeywords", "concurrency", "createdAt", "elapsedMs", "failedKeywords", "id", "name", "productsPerKeyword", "profileId", "randomMin", "randomProducts", "scrapeMode", "status", "totalKeywords", "updatedAt") SELECT "completedKeywords", "concurrency", "createdAt", "elapsedMs", "failedKeywords", "id", "name", "productsPerKeyword", "profileId", "randomMin", "randomProducts", "scrapeMode", "status", "totalKeywords", "updatedAt" FROM "Project";
DROP TABLE "Project";
